...
---
= Comandos de administradores de CLI de SANtricity
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La siguiente lista de comandos de administrador están disponibles en el sistema de almacenamiento E-Series.
...
link:../commands-a-z/create-snmpuser-username.html["Registre el usuario USM de SNMPv3"]
...
link:../commands-a-z/show-storagearray-autosupport.html["Muestra la configuración de AutoSupport"]
...
link:../commands-a-z/show-allsnmpusers.html["Muestra el usuario USM de SNMPv3"]
...
link:../commands-a-z/delete-snmpuser-username.html["Cancele el registro del usuario USM de SNMPv3"]

link:../commands-a-z/set-snmpcommunity.html["Actualice la comunidad SNMP"]

link:../commands-a-z/set-snmpuser-username.html["Actualice el usuario USM de SNMPv3"]
