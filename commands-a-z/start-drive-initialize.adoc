...
summary: El comando start drive initialize acciona la inicialización de la unidad. 
---
= Inicialización de la unidad de inicio - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La `start drive initialize` comando inicia una inicialización de la unidad.
...
[NOTE]
====
*Posibles daños en la configuración de la cabina de almacenamiento* -- tan pronto como introduce este comando, se destruyen todos los datos de usuario.
