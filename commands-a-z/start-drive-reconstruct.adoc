...
summary: El comando start drive reconstruct comienza la reconstrucción de una unidad. 
---
= Iniciar reconstrucción de la unidad - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La `start drive reconstruct` el comando comienza la reconstrucción de una unidad.
