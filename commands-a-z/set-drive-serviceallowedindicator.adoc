...
summary: El comando set drive serviceAllowedIndicator enciende o apaga la luz indicadora de permiso de acción de servicio en una o varias unidades en soportes de unidades que admiten la función de luz indicadora. 
---
= Establecer el indicador de acción de servicio de la unidad permitida - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La `set drive serviceAllowedIndicator` El comando enciende o apaga la luz indicadora de permiso de acción de servicio en una unidad o unidades en soportes de unidades compatibles con la función de luz indicadora de permiso de acción de servicio.
