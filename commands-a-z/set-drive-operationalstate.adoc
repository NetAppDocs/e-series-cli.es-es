...
summary: El comando set drive operationalState configura una unidad en el estado Failed. 
---
= Establecer el estado de la unidad - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La `set drive operationalState` El comando configura una unidad con el estado Failed.
...
Para volver a colocar una unidad en el estado Optimal, utilice `revive drive` comando.
