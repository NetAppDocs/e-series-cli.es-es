...
summary: El comando revive drive fuerza la unidad especificada al estado Optimal. 
---
= Reactivar la unidad - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La `revive drive` El comando fuerza a la unidad especificada al estado Optimal.
